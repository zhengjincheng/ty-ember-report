...
$(function(){
	...
	//提交页面 -迁移到 criteria_application.jsp
...
function setInitHeight(){
	$("div.content_sidebar :first").height(initHeight);
}
function setPageHeight(id){
	var height = $("div.content_sidebar :first").height();
	...
	$("div.content_sidebar :first").height(maxHeight+45);
}
function calcTop(){
